...
option("deterministic_log")
    set_showmenu(true)
    set_description("Use a deterministic log file name")
    add_defines("DETERMINISTIC_LOG")

target("doorstop")
    set_kind("shared")
    set_optimize("smallest")
    add_options("include_logging")
    add_options("deterministic_log")
    local load_events = {}
